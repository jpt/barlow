...
Thank you Paulo Silva (@nitrofurano) for the photo of the DIN grid, because that was how this started. Thank you Lukas Schneider for donating LS Cadencer to EFF. Thank you Dave Crossland (@davelab6) and Thomas Phinney (@tphinney) of [Crafting Type](http://craftingtype.com) for the guidance and early feedback. Thank you Hugh D'Andrade for noticing all the little things. (Damn you, Hugh D'Andrade, for noticing all the little things).
